...
class _inventairecafaState extends State<inventairecafa> {
 ...
 var jsonBody1 = response1.body;
  ...
  }var cump=  double.parse(jsonData1[0]['asCmup']) ;
channelListb..add(Channelb(jsonData1[0]['arRef'],jsonData1[0]['arDesign'],jsonData1[0]['deCode'],imags, jsonData1[0]['deIntitule'],double.parse(jsonData1[0]['asQtesto']) ,null,jsonData1[0]['arCodebarre'],null,cump));
              ...
              child: Column(
                ...
                child: Row(
                  ...
                  MaterialPageRoute(builder: (context) => invacc(aname: "${widget.aname}",email:"${widget.email}",url:"${widget.url}",  entre:widget.entre,
                        ...
                        return warningDialog(context, "Remplir tous les champs");
                ...
                Expanded(
                  ...
                  child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        var a =      removeTrailingZero(channelListb[index].qteAjust.toString())        ;
                        var b = removeTrailingZero(channelListb[index].qtesto.toString());
                  ...
                  qteController1.text=channelListb[index].qtesto.toString();
                  prixController1.text=channelListb[index].cump.toString();
                                     ...
                                     children: [VerticalDivider(),
                                       Container( width: c_width1, padding: const EdgeInsets.only(top:10.0,right:5,left:5,bottom:3),
                                               ...
                                               channelListb[index].prixAjust!=null ? Text(
                                                     ...
                                                     removeTrailingZero(channelListb[index].prixAjust.toString()) ,style: TextStyle(color: Colors.blue,fontSize: 18,fontWeight: FontWeight.bold), ):SizedBox.shrink(),
