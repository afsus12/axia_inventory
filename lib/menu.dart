                                  ...
                                  child: GestureDetector(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        ...
                                        gradient:widget.entre==true? LinearGradient(
                                          begin: Alignment.topRight,
                                          end: Alignment.bottomLeft,
                                          colors: [
                                            Color(0xffDE6262),
                                         ...
                                         child: ClipOval(
                                           child: GestureDetector(
                                             ...
                                             child: Container(
                                               ...
                                               decoration: BoxDecoration(
                                                 shape: BoxShape.circle,
                                                 gradient:widget.sortie==true?LinearGradient(
                                                   begin: Alignment.topRight,
                                                   end: Alignment.bottomLeft,
                                                   colors: [
                                                     Color(0xffDE6262),
                                ...
                                child: ClipOval(
                                  child: GestureDetector(
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        shape: BoxShape.circle,
                                        gradient:widget.transfer==true? LinearGradient(
                                          begin: Alignment.topRight,
                                          end: Alignment.bottomLeft,
                                          colors: [
                                            Color(0xffDE6262),
                          ...
                          child: Stack(
                            children: [
                              Center(
                                child: ClipOval(
                                  child: GestureDetector(
                                    onTap: () {if(widget.inventaires==true){
                                      setState(() {
                                        print('clicked');
                                        Navigator.push(
                                          context,
                                    ...
                                    child: Container(
                                      ...
                                      decoration: BoxDecoration(
                                        shape: BoxShape.circle,
                                        gradient:widget.inventaires==true? LinearGradient(
                                          begin: Alignment.topRight,
                                          end: Alignment.bottomLeft,
                                          colors: [
                                            Color(0xffDE6262),
                                   ...
                                   child: ClipOval(
                                     child: GestureDetector(
                                       ...
                                       child: Container(
                                         ...
                                         decoration: BoxDecoration(
                                           shape: BoxShape.circle,
                                           gradient:widget.consult==true? LinearGradient(
                                             begin: Alignment.topRight,
                                             end: Alignment.bottomLeft,
                                             colors: [
                                               Color(0xffDE6262),
